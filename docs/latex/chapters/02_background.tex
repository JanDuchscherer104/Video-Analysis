...
%--------------------------------------------------------------------
\subsection*{Pointers to Appendix}
Detailed mathematical formulations, Gabor filter steerability proofs, deformable attention mechanics, loss functions, layer-wise architectural diagrams, and complete ablation studies are provided in Appendix~\ref{app:caspnet_details}\dots\ref{app:caspformer_extra}.
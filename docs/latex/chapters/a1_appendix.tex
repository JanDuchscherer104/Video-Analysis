% Appendix
\appendix
\chapter{Citations and References} % (fold)
\label{ch:citations_and_references}

\section{Examples of Citations} % (fold)
...
\section{References within the Document} % (fold)
...
\begin{itemize}
	\item section~\ref{ch:introduction} on page \pageref{sec:introduction}
\end{itemize}

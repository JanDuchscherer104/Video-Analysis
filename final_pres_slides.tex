...
\begin{frame}[plain]
  \begin{center}
    ...
    \vfill
    {\Large Breaking Free from Agent-Centric Limitations}
    \vfill
  \end{center}
\end{frame}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.6\textwidth, height=0.7\textheight, keepaspectratio]{docs/latex/figures/qc_reference_frame.png}
...
Agents form unordered sets—no element privileged. For permutation $\sigma$: $f_{\boldsymbol{\Psi}}(\sigma \cdot \mathcal{S}) = \rho(\sigma) f_{\boldsymbol{\Psi}}(\mathcal{S})$
...
\begin{frame}[plain]
  \begin{center}
    ...
    \vfill
    {\Large MTR, LMFormer, and CASPFormer}
    \vfill
  \end{center}
\end{frame}
...
\begin{frame}{Encoder: Learnable Fourier Embeddings}
  \begin{columns}[T]
    ...
    \column{0.38\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\columnwidth,height=0.25\textheight,keepaspectratio]{docs/latex/figures/lff_high_freq.png}\\[0.5em]
        \includegraphics[width=\columnwidth,height=0.25\textheight,keepaspectratio]{docs/latex/figures/lff_low_freq_ball.png}\\[0.5em]
